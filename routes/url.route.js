...
import { createShortUrl, deleteShortUrl, editShortUrl, getMyUrls, getSpecificUrlAnalytics, getUrlAnalytics } from "../controllers/url.controller.js";
...
router.get('/track/:id', getSpecificUrlAnalytics)
//secured routes
